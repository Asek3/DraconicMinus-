...
import ru.nanolive.draconicplus.common.fusioncrafting.client.render.vertex.VertexFormatElement.EnumType;
...
public class DefaultVertexFormats {
    ...
    static {
        POSITION_3F = new VertexFormatElement(0, EnumType.FLOAT, EnumUsage.POSITION, 3);
        COLOR_4UB = new VertexFormatElement(0, EnumType.UBYTE, EnumUsage.COLOR, 4);
        TEX_2F = new VertexFormatElement(0, EnumType.FLOAT, EnumUsage.UV, 2);
        TEX_2S = new VertexFormatElement(1, EnumType.SHORT, EnumUsage.UV, 2);
        NORMAL_3B = new VertexFormatElement(0, EnumType.BYTE, EnumUsage.NORMAL, 3);
        PADDING_1B = new VertexFormatElement(0, EnumType.BYTE, EnumUsage.PADDING, 1);
