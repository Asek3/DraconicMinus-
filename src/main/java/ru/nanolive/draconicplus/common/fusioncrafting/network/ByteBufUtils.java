...
public class ByteBufUtils {
     ...
     * @throws IOException 
     */
    public static void writeItemStack(ByteBuf to, ItemStack stack) throws IOException
    {
     ...
     * @throws IOException 
     */
    public static void writeTag(ByteBuf to, NBTTagCompound tag) throws IOException
    {
        PacketBuffer pb = new PacketBuffer(to);
